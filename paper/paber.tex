...
\begin{document}
	...
	\begin{wrapfigure}{l}{0.43\textwidth}
		...
		\label{fig:dist}
	\end{wrapfigure}
	Sellel mudelil on raskusi realistlike kunstiteoste genereerimisega \seefig{coco}. Kuna andmekogu sisaldab pilte mitmetest erilaadi objektitest, on AttnGANil raskusi seose leidmisega teksti ja 
